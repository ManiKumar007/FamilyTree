...
class _SignupScreenState extends ConsumerState<SignupScreen> {
  ...
  Future<void> _signUpWithGoogle() async {
    developer.log('🔐 Google sign up attempt started', name: 'SignupScreen');
    
    setState(() { _isLoading = true; _error = null; });
    try {
      final authService = ref.read(authServiceProvider);
      developer.log('📞 Calling authService.signInWithGoogle', name: 'SignupScreen');
      
      await authService.signInWithGoogle();
      
      developer.log('✅ Google sign up initiated', name: 'SignupScreen');
  ...
  Future<void> _signUpWithPhone() async {
    developer.log('📱 Phone sign up initiated', name: 'SignupScreen');
